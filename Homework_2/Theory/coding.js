function display2_1() {
  var myanswer  = "My answer goes here: Undefined, True, False -- null and undefined essentially mean the same thing - that a variable has no value,\
                  however, they do not have the same type so === is false" // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: this would result in error. Use strict prevents the use of undeclared variables but if it's removed\
                  the variable becomes an implicit global variable" // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: This shows children not on the html page because two of the tags are hidden using the display: none\
  attribute and the third tag is a p tag without any actual text" // TODO 2.5: Fill in Answer here
